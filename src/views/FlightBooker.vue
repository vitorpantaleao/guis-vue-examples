    ...
    <div>
        ...
        <div class="flex items-center gap-5 mt-4">
            ...
            <div>
                ...
                <input type="date" v-model="dataPartida" class="w-44 h-10 flex text-xl px-2">
            </div>
            <div>
                <label class="text-base block">Data de retorno</label>
                <input type="date" v-model="dataRetorno" :disabled="!isVolta" class="w-44 h-10 flex text-xl px-2">
            </div>
        </div>
        ...
        <button :disabled="!podeReservar" @click="reservar" class="mt-4 bg-primary-color hover:bg-secondary-color text-white font-bold py-2 px-4 rounded">Reservar</button>
